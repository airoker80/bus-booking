 ...
 */
public class KtmMk extends AppCompatActivity  {
    final String up_URL="http://192.168.43.92/Test/booked1.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,up_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(KtmMk.this, response, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(KtmMk.this, error.toString(), Toast.LENGTH_LONG).show();
