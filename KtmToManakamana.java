 ...
 */
public class KtmToManakamana extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    String no_of_seats;
    Spinner sp,sp1;
    ...
    String url="http://192.168.0.108/Test/seatsinfo1.php";
    String sp_url="http://192.168.0.108/Test/sp_id.php";
    String id_url="http://192.168.0.108/Test/route_id1.php";
    private static final String BOOK_URL="http://192.168.0.108/Test/book2.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ktm_to_mk);
    ...
    public void  book(){
        ...
        final String av_seats=no_of_seats;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BOOK_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(KtmToManakamana.this, response, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(KtmToManakamana.this, error.toString(), Toast.LENGTH_LONG).show();
    ...
    private class BackTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://192.168.0.108/Test/spin1.php");
    ...
    private class BackTask1 extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                HttpClient httpClient =new DefaultHttpClient();
                HttpPost httpPost = new HttpPost("http://192.168.0.108/Test/bus_no1.php");
                HttpResponse httpResponse =httpClient.execute(httpPost);
                HttpEntity entity =httpResponse.getEntity();
                inputStream = entity.getContent();
            } catch (ClientProtocolException e) {
    ...
    public void test(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(KtmToManakamana
    ...
    private void openProfile(String response){
        try {
            ...
            //JSONObject Jobj1 =result1.getJSONObject(0);
            //JSONObject Jobj2 =result1.getJSONObject(0);

            no_of_seats=Jobj.getString("no_of_seats");
            String date=Jobj.getString("date");
            String time=Jobj.getString("time");
            String price=Jobj.getString("price");
            result.setText(no_of_seats);
            dtr.setText("Date :"+date +"\n"+"Time :"+time+"\n"+"Price :"+price);
        } catch (JSONException e) {
            e.printStackTrace();
        }
