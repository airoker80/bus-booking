 ...
 */
public class ManakamanaToPokharaBooking extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener{
    Spinner sp,sp1;
    public String name,date,time,price;
    TextView result,result12,result2,result3;
    Button bt1,bt2;
    EditText etb1,etb2,etb3;
    String url="http://192.168.43.92/Test/seatsinfo2.php";
    ...
    private class BackTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://192.168.43.92/Test/spin2.php");
    ...
    public void onClick(View v) {
        if(v==bt1){
                ...
                Intent intent =new Intent(ManakamanaToPokharaBooking.this,MkPkseeBook.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            ...
                            Toast.makeText(ManakamanaToPokharaBooking.this, response, Toast.LENGTH_LONG).show();
                            openProfile(response);
                        }
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ManakamanaToPokharaBooking
