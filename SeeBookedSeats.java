 ...
 */
public class SeeBookedSeats  extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
    ListView listView;
    private static final String LOGIN_URL = "http://192.168.0.109/Test/login1.php";
    public static final String URL_GET_seat = "http://192.168.43.92/Test/seebookedseats.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            ...
                            Toast.makeText(SeeBookedSeats.this, response, Toast.LENGTH_LONG).show();
    ...
    private void op(String response) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    SeeBookedSeats.this, list, R.layout.costume_layout,
                    new String[]{Config.TAG_ID, Config.TAG_Route,Config.TAG_Bus_id},
                    new int[]{R.id.Cv_1, R.id.CV_2,R.id.CV_3});
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
       // String Id=parent.getItemAtPosition(0).toString();
        ...
        Intent intent=new Intent(SeeBookedSeats.this,BookedSeats.class);
