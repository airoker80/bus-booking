 ...
 */
public class Reserve extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener {
    Spinner sp,sp1;
    public String name1,name2;
    TextView result;
    Button bt1,bt2;
    EditText etb1,etb2,etb3;
    String url="http://192.168.0.108/Test/seatsinfo.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BOOK_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(Reserve.this, response, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Reserve.this, error.toString(), Toast.LENGTH_LONG).show();
    ...
    private class BackTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://192.168.0.108/Test/spin.php");
    ...
    private class BackTask1 extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                HttpClient httpClient =new DefaultHttpClient();
                HttpPost httpPost = new HttpPost("http://192.168.0.108/Test/bus_no.php");
                HttpResponse httpResponse =httpClient.execute(httpPost);
                HttpEntity entity =httpResponse.getEntity();
                inputStream = entity.getContent();
            } catch (ClientProtocolException e) {
