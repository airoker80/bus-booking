 ...
 */
public class MkPkseeBook extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
    ListView listView;
    private static final String LOGIN_URL = "http://192.168.0.109/Test/login1.php";
    public static final String URL_GET_seat = "http://192.168.43.92/Test/seebookedseats2.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            ...
                            Toast.makeText(MkPkseeBook.this, response, Toast.LENGTH_LONG).show();
    ...
    private void op(String response) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    MkPkseeBook.this, list, R.layout.costume_layout,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(MkPkseeBook.this,MkPk.class);
